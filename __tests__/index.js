...
describe("Get + Set", () => {
  ...
  it("set Second", () => {
    const m = moment(time).seconds(30).valueOf();
  ...
  it("set Hour", () => {
    const m = moment(time).hour(13).valueOf();
  ...
  it("set Date of Month", () => {
    const m = moment(time).date(4).valueOf();
  ...
  it("set Day of Week", () => {
    const m = moment(time).day(-14).valueOf();
  ...
  it("set Day of Year", () => {
    const m = moment(time).dayOfYear(256).valueOf();
  ...
  it("set Week of Year", () => {
    const m = moment(time).week(24).valueOf();
...
describe("Display", () => {
  ...
  it("Time from now", () => {
    ...
    const d = date.formatDistance(new Date(time), new Date(), { addSuffix: true });
  ...
  it("Difference", () => {
    ...
    const d = date.differenceInMilliseconds(new Date(2007, 0, 27), new Date(2007, 0, 29));
    expect(m).toBe(d);

    const m2 = moment([ 2007, 0, 27 ]).diff(moment([ 2007, 0, 29 ]), 'days');
    const d2 = date.differenceInDays(new Date(2007, 0, 27), new Date(2007, 0, 29));
    expect(m2).toBe(d2);
  });
...
describe("Query", () => {
  ...
  it("Is Same", () => {
    ...
    expect(date.isSameDay(new Date(2010, 9, 20), new Date(2010, 9, 21))).toBeFalsy();

    expect(moment('2010-10-20').isSame('2010-10-21', 'month')).toBeTruthy();
    expect(date.isSameMonth(new Date(2010, 9, 20), new Date(2010, 9, 21))).toBeTruthy();
  });
